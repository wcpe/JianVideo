...
export const mockData = {
  ...
  set paths(v: LibraryPath[]) { paths = v },
  get mediaFiles() { return mediaFiles },
  set mediaFiles(v: MediaFile[]) { mediaFiles = v },
  get nextPathId() { return nextPathId++ },
  get nextMediaId() { return nextMediaId++ },
}
