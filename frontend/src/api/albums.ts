...
export function listAlbums() { return useMock ? mockListAlbums() : realListAlbums() }
export function createAlbum(name: string, description = '') { return useMock ? mockCreateAlbum(name, description) : realCreateAlbum(name, description) }
export function deleteAlbum(id: number) { return useMock ? mockDeleteAlbum(id) : realDeleteAlbum(id) }
export function listAlbumItems(albumID: number) { return useMock ? mockListAlbumItems(albumID) : realListAlbumItems(albumID) }
export function addAlbumItem(albumID: number, mediaID: number) { return useMock ? mockAddAlbumItem(albumID, mediaID) : realAddAlbumItem(albumID, mediaID) }
export function removeAlbumItem(albumID: number, mediaID: number) { return useMock ? mockRemoveAlbumItem(albumID, mediaID) : realRemoveAlbumItem(albumID, mediaID) }
