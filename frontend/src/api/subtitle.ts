...
export function getSubtitles(mediaId: number) { return useMock ? mockGetSubtitles(mediaId) : realGetSubtitles(mediaId) }
export function getSubtitleContent(mediaId: number, index: number) { return useMock ? mockGetSubtitleContent(mediaId, index) : realGetSubtitleContent(mediaId, index) }
