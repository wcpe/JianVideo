...
function libPath(over: Partial<LibraryPath> = {}): LibraryPath {
  return {
    id: 1, path: 'D:/Videos', type: 'local', label: '视频', enabled: true,
    created_at: '2025-01-01T00:00:00Z', media_count: 0, ...over,
  }
}
...
function mediaFile(over: Partial<MediaFile> = {}): MediaFile {
  return {
    ...
    bitrate: 0, subtitle_tracks: '', added_at: '2025-01-01T00:00:00Z',
