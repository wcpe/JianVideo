...
function buildMedia(id: number, name: string, lastPosition: number, duration: number): MediaFile {
  return {
    id, library_id: 1, file_path: `D:/Videos/${name}`, file_name: name,
    file_size: 1024, format: 'mp4', video_codec: 'h264', audio_codec: 'aac',
    duration, width: 1920, height: 1080, bitrate: 5000000, subtitle_tracks: '',
    added_at: '2025-01-01T12:00:00Z', modified_at: '2025-01-01T12:00:00Z',
    last_position: lastPosition, watched: false, last_watched_at: '2025-01-01T12:00:00Z',
  }
}
