...
export default function ConsolePage() {
  ...
  return (
    <Tabs className="console-tabs" value={activeTab} onChange={handleTabChange} keepMounted={false}>
      ...
      <Tabs.Panel value={TAB_ENV}><SystemPage section={TAB_ENV} /></Tabs.Panel>
      <Tabs.Panel value={TAB_HWACCEL}><SystemPage section={TAB_HWACCEL} /></Tabs.Panel>
      <Tabs.Panel value={TAB_CODEC}><SystemPage section={TAB_CODEC} /></Tabs.Panel>
      <Tabs.Panel value={TAB_UPDATE}><SystemPage section={TAB_UPDATE} /></Tabs.Panel>
      <Tabs.Panel value={TAB_SETTINGS}><SettingsPage /></Tabs.Panel>
    </Tabs>
  )
}
