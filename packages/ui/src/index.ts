export type ComponentState =
  ...
  | "dense"
  | "mobile";
export type UiPreviewGroup =
  "basic" | "media" | "task" | "space" | "feedback" | "pixi" | "theme";
...
export const uiPreviewCatalog: readonly UiPreviewDescriptor[] = [
  preview("action-button", "按钮", "basic", "ActionButtonPreview", [
    "default",
    "loading",
    "disabled",
  ]),
  preview("text-input", "输入框", "basic", "TextInputPreview", [
    "default",
    "error",
    "disabled",
  ]),
  preview("menu-button", "菜单按钮", "basic", "MenuButtonPreview", [
    "default",
    "selected",
    "disabled",
  ]),
  preview("data-table", "数据表格", "basic", "DataTablePreview", [
    "default",
    "empty",
    "loading",
    "dense",
  ...
  preview(
    ...
    "media",
    "MediaCardPreview",
    ["default", "loading", "error", "selected"],
    ["normal-library", "million-assets"],
  ),
  preview(
    "hls-preview-card",
    "HLS 预览卡",
    "media",
    "HlsPreviewCardPreview",
    ["default", "loading", "error"],
    ["hls-pending", "transcode-failed"],
  ),
  preview(
    "thumbnail-status",
    "缩略图状态",
    "media",
    "ThumbnailStatusPreview",
    ["default", "loading", "error", "empty"],
    ["missing-thumbnail", "normal-library"],
  ),
  preview(
    "task-status",
    "转码任务状态",
...
export function groupUiPreviews(
  items: readonly UiPreviewDescriptor[],
): Record<UiPreviewGroup, readonly UiPreviewDescriptor[]> {
  return {
