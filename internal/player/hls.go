...
// HLSSegmentWriter 管理单个媒体文件的 HLS 切片写入。
...
func NewHLSSegmentWriter(baseDir string, mediaID int64) (*HLSSegmentWriter, error) {
...
func (w *HLSSegmentWriter) WriteSegment(data []byte) error {
	...
	segName := fmt.Sprintf("segment_%03d.ts", w.seq)
